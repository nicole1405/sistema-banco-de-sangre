namespace BBMS
{
    partial class Layout
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sidebarPanel.Controls.Add(this.BtnMainPanel);
            this.sidebarPanel.Controls.Add(this.BtnListaPaciente);
            this.sidebarPanel.Controls.Add(this.BtnEmployee);
            this.sidebarPanel.Controls.Add(this.btnDonante);
            this.sidebarPanel.Controls.Add(this.btnInventario);
            this.sidebarPanel.Controls.Add(this.btnPaciente);
